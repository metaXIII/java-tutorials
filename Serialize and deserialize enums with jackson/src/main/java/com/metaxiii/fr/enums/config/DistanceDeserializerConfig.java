...
public class DistanceDeserializerConfig extends StdDeserializer<DistanceDeserializer> {
    ...
    @Override
    public DistanceDeserializer deserialize(final JsonParser jsonParser, final DeserializationContext ctxt) throws IOException {
