...
public class SimpleMail {
  ...
  private static void sendEmail(final Email email) {
    try (final Mailer mailer =
        MailerBuilder.withSMTPServer("smtp.example.com", 25, "username", "password")
  ...
  public static void sendEmailWithAttachment() {
    final Email email =
        EmailBuilder.startingBlank()
            ...
            .withAttachment(
                "important_document.pdf", new FileDataSource("path/to/important_document.pdf"))
            .buildEmail();
    sendEmail(email);
  }
  ...
  public static void sendEmailWithMultipleAttachment() {
    ...
    arList.add(
        new AttachmentResource(
            "important_document.pdf", new FileDataSource("path/to/important_document.pdf")));
    arList.add(
        new AttachmentResource("company_logo.png", new FileDataSource("path/to/company_logo.png")));
    final Email email =
        EmailBuilder.startingBlank()
            .from(SENDER_EXAMPLE_COM)
            .to(RECIPIENT_EXAMPLE_COM)
